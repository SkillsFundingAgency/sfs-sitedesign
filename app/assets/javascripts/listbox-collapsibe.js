...
aria.ListboxButton = function (button, listbox,click) {
  this.button = button;
...
aria.ListboxButton.prototype.registerEvents = function () {
  ...
  this.listbox.listboxNode.addEventListener('click',this.clicked.bind(this))
};

aria.ListboxButton.prototype.clicked = function (evt) {
  this.function(evt.target.getAttribute("data-filter"))
