! function() {
    ...
    var t = e(function(e, t) {
                        ...
                        t || Object.defineProperty(Function.prototype, "bind", {
                            value: function(t) {
                                ...
                                var p = i.slice,
                                    ...
                                    m = Math.max,
                                    h = this;
                                if (!n(h)) throw new TypeError("Function.prototype.bind called on incompatible " + h);
                                for (var y, b = p.call(arguments, 1), v = m(0, h.length - b.length), w = [], E = 0; E < v; E++) f.call(w, "$" + E);
                                return y = Function("binder", "return function (" + w.join(",") + "){ return binder.apply(this, arguments); }")(function() {
                                    if (this instanceof y) {
                                        var e = h.apply(this, d.call(b, p.call(arguments)));
                                        return o(e) === e ? e : this
                                    }
                                    return h.apply(t, d.call(b, p.call(arguments)))
                                }), h.prototype && (c.prototype = h.prototype, y.prototype = new c, c.prototype = null), y
                            }
                        })
                    }.call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof n && n || {}),
                    function(o) {
        ...
        o = e(function(e, t) {
            e.exports = function() {
                ...
                return e.prototype.handleKeyDown = function(e) {
                    ...
                    if ("true" === e.target.getAttribute("data-prevent-double-click")) return t ? (e.preventDefault(), !1) : void(t = setTimeout(function() {
                        t = null
                    }, 1e3))
        ...
        r = e(function(e, t) {
            e.exports = function() {
                ...
                var i = "boolean" == typeof document.createElement("details").open;

                function e(e) {
                    this.$module = e
                }
                return e.prototype.handleInputs = function(e, n) {
                    ...
                    return t.setAttribute("aria-expanded", o ? "false" : "true"), n.setAttribute("aria-hidden", r ? "false" : "true"), i || (n.style.display = o ? "none" : "", null !== e.getAttribute("open") ? e.removeAttribute("open") : e.setAttribute("open", "open")), !0
        ...
        i = e(function(e, t) {
            e.exports = function() {
                function e(e) {
                    this.$module = e, this.$textarea = e.querySelector(".js-character-count")
                }
                return function(e) {
                        var a, s, l, u;
                    ...
                    function(e) {
                        ...
                        if (this.$textarea) {
                            ...
                            if (this.options.maxwords && (t = this.defaults.wordCountAttribute), this.maxLength = e.getAttribute(t), this.maxLength) {
                                ...
                                this.countMessage = n(), this.countMessage && (e.removeAttribute("maxlength"), this.bindChangeEvents.bind(this)(), this.updateCountMessage.bind(this)())
                            }
                        }
                    ...
                    }, e.prototype.createCountMessage = function() {
                        var e = this.$textarea,
                            t = e.id,
                            n = document.getElementById(t + "-info");
                        return t && !n ? (e.insertAdjacentHTML("afterend", '<span id="' + t + '-info" class="govuk-hint govuk-character-count__message" aria-live="polite"></span>'), this.describedBy = e.getAttribute("aria-describedby"), this.describedByInfo = this.describedBy + " " + t + "-info", e.setAttribute("aria-describedby", this.describedByInfo), n = document.getElementById(t + "-info")) : e.insertAdjacentElement("afterend", n), n
            ...
            e.exports = function() {
                ...
                return function(e) {
                    ...
                    function(e) {
                        ...
                        return !!o && (window.history.pushState ? window.history.pushState(null, null, "#" + t) : window.location.hash = t, o.scrollIntoView(), n.focus({
                            preventScroll: !0
                        }), !0)
            ...
            e.exports = function() {
                ...
                return function(e) {
                    ...
                    function(e) {
                        ...
                        e.setAttribute("aria-expanded", t);
                        var n = this.$module.querySelector("#" + e.getAttribute("aria-controls"));
                        n && n.classList.toggle("govuk-radios__conditional--hidden", !t)
                    }, e.prototype.handleClick = function(e) {
                        t(this.$inputs, function(e) {
                            var t = "radio" === e.getAttribute("type"),
                                n = e.getAttribute("aria-controls");
                            t && n && this.setAttributes(e)
                        }.bind(this))
                    }, e
            }()
        }),
            ...
            e.exports = function() {
                ...
                return function(e) {
                    ...
                    function(i) {
                        ...
                        var e = this.$module;
                        if (e) {
                            var t = e.querySelector(".js-header-toggle");
            ...
            e.exports = function() {
                ...
                return function(e) {
                    ...
                    function(i) {
                        ...
                        e.removeAttribute("id"), e.removeAttribute("role"), e.removeAttribute("aria-controls"), e.removeAttribute("tabindex");
                        ...
                        if (t) var n = t.firstElementChild;
                        ...
                        e.setAttribute("aria-selected", "false"), e.classList.remove("govuk-tabs__tab--selected"), e.setAttribute("tabindex", "-1")
                    }, e.prototype.highlightTab = function(e) {
                        e.setAttribute("aria-selected", "true"), e.classList.add("govuk-tabs__tab--selected"), e.setAttribute("tabindex", "0")
    ...
    new o(document).init();
    var p = document.querySelector('[data-module="accordion"]');
    p && new t(p).init();
    ...
    if (f) {
        var m = new a(f);
        m.init = function() {
            this.$module.addEventListener("click", a.prototype.handleClick.bind(this))
        }, m.init()
    }
    var h = document.querySelector('[data-module="character-count"]');
    h && new i(h).init();
    var y = document.querySelector('[data-module="checkboxes"]');
    y && new c(y).init();
    var b = document.querySelector('[data-module="radios"]');
    b && new s(b).init();
    var v = document.querySelector('[data-module="header"]');
    v && new l(v).init();
    var w = document.querySelector('[data-module="tabs"]');
    w && new u(w).init()
}();
