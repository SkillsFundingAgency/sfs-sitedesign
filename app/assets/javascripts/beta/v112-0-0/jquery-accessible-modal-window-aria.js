jQuery(document).ready(function($) {
    ...
    $body.on('click', '.js-modal', function(event) {
        ...
        if ($modal_title !== '') {
            // Chris Harding (26.09.19) - Added in the global GOV.UK Elements "heading-large" class
            $modal_code += '<h1 id="modal-title" class="' + $modal_prefix_classes + 'heading-large modal-title">' + $modal_title + '</h1>';
            // $modal_code += '<h1 id="modal-title" class="' + $modal_prefix_classes + 'modal-title">' + $modal_title + '</h1>';
        }

        if ($modal_text !== '') {
            // Chris Harding (26.09.19) - Removed the <p> tags wrapping automatically around the content
            $modal_code += $modal_text;
