module.exports = function(router) {
	...
	* **********/
	...
	/**********
	* PROTOTYPE
	* ARCHIVE PAGE (kanban-beta-v116-0-0)
	* **********/

	// Render session variables needed for the archive page
	router.get('/archive/beta/kanban-beta-v116-0-0', function (req, res) {
		res.render('archive/beta/kanban-beta-v116-0-0', {
			'version' : version,
			'latestVersion' : version,
			'latestVersionVLF' : latestVersionVLF,
			'latestVersionNFF' : latestVersionNFF,
